...
@click.option(
    "--rocky-vault-mirror",
    envvar="ROCKY_VAULT_MIRROR",
    default="https://dl.rockylinux.org/vault/rocky",
...
@click.option(
    ...
    envvar="VARIANT",
    default="generic",
    help="Debian Cloud Linux variant; can be genericcloud, generic, or nocloud",
)
@click.option(
    "--mirror",
    envvar="DEBIAN_MIRROR",
    default="https://cloud.debian.org/images/cloud",
    help="Debian mirror",
)
...
@click.option(
    ...
    envvar="BRANCH",
    default="edge",
    help="Armbian branch, usually current/edge/legacy",
)
@click.option(
    "--extra-release",
    envvar="EXTRA_RELEASE",
    default="",
    help="Extra release, for example k8s-1.28",
)
